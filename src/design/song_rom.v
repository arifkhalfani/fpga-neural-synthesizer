...
module song_rom (					
	...
	assign memory[	 28	] =	{6'd0, 6'd10};	// Note: rest
	assign memory[	 29	] =	{6'd0, 6'd10};	// Note: rest
	assign memory[	 30	] =	{6'd0, 6'd15};	// Note: rest
	assign memory[	 31	] =	{6'd0, 6'd15};	// Note: rest
	...
	assign memory[	 96	] =	{6'd0, 6'd10};	// Note: rest
	assign memory[	 97	] =	{6'd47, 6'd22};	// Note: 4G
	assign memory[	 98	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	 99	] =	{6'd47, 6'd22};	// Note: 4G
	assign memory[	100	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	101	] =	{6'd47, 6'd22};	// Note: 4G
	assign memory[	102	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	103	] =	{6'd43, 6'd16};	// Note: 4D#Eb
	assign memory[	104	] =	{6'd50, 6'd8};	// Note: 5A#Bb
	assign memory[	105	] =	{6'd47, 6'd22};	// Note: 4G
	assign memory[	106	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	107	] =	{6'd43, 6'd16};	// Note: 4D#Eb
	assign memory[	108	] =	{6'd50, 6'd8};	// Note: 5A#Bb
	assign memory[	109	] =	{6'd47, 6'd48};	// Note: 4G
	assign memory[	110	] =	{6'd0, 6'd24};	// Note: rest
	assign memory[	111	] =	{6'd54, 6'd22};	// Note: 5D
	assign memory[	112	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	113	] =	{6'd54, 6'd22};	// Note: 5D
	assign memory[	114	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	115	] =	{6'd54, 6'd22};	// Note: 5D
	assign memory[	116	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	117	] =	{6'd55, 6'd16};	// Note: 5D#Eb
	assign memory[	118	] =	{6'd50, 6'd8};	// Note: 5A#Bb
	assign memory[	119	] =	{6'd46, 6'd22};	// Note: 4F#Gb
	assign memory[	120	] =	{6'd0, 6'd2};	// Note: rest
	assign memory[	121	] =	{6'd43, 6'd16};	// Note: 4D#Eb
	assign memory[	122	] =	{6'd50, 6'd8};	// Note: 5A#Bb
	assign memory[	123	] =	{6'd47, 6'd48};	// Note: 4G
	assign memory[	124	] =	{6'd0, 6'd10};	// Note: rest
	assign memory[	125	] =	{6'd0, 6'd10};	// Note: rest
	assign memory[	126	] =	{6'd0, 6'd10};	// Note: rest
	assign memory[	127	] =	{6'd0, 6'd10};	// Note: rest
endmodule